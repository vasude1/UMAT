...
void viscous_branch::set_viscous_para(double dt,model* material){
...
template <typename model>
void viscous_branch::compute_tangent_nr_principal(model* material){
...
template <typename model>
void viscous_branch::compute_residual_principal(model* material){
...
template <typename model>
Matrix2d viscous_branch::update_intervar_newton_principal(Matrix2d F,model* material){
  eigs = eigs_tr;
